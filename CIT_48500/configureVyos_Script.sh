...
# ------------------------------
set firewall ipv4 name ALLOW-ESTABLISHED default-action 'reject'   # default deny
set firewall ipv4 name ALLOW-ESTABLISHED rule 10 action 'accept'   # allow established/related
...
set firewall ipv4 name ALLOW-ESTABLISHED rule 20 action 'accept'   # allow PPTP (tcp/1723)
...
set firewall ipv4 name eth0-Inbound rule 3000 action 'accept'     # placeholder rule (accept)

set firewall ipv4 name eth0-Outbound default-action 'accept'
set firewall ipv4 name eth0-Outbound rule 10 action 'accept'      # allow established outbound
...
set firewall ipv4 name eth1-inside-filter rule 10 action 'accept'      # allow established from storage->mgmt
...
set firewall ipv4 name eth1-inside-filter rule 3000 action 'drop'      # block storage->class
...
set firewall ipv4 name eth1-inside-filter rule 3010 action 'drop'      # block new connections storage->mgmt
...
set firewall ipv4 name eth1-outside-filter rule 10 action 'accept'     # mgmt->storage allow new & established
...
set firewall ipv4 name eth1-outside-filter rule 3000 action 'drop'     # block class->mgmt to storage
...
set firewall ipv4 name eth2-Inbound rule 3000 action 'accept'     # placeholder
...
set firewall ipv4 name eth3-inside-filter rule 10 action 'accept'      # mgmt->storage allow new & established
...
set firewall ipv4 name eth3-inside-filter rule 20 action 'accept'      # mgmt->class allow new & established
...
set firewall ipv4 name eth3-local-filter rule 30 action 'accept'      # mgmt->storage to router local
...
set firewall ipv4 name eth3-local-filter rule 40 action 'accept'      # mgmt->class to router local
...
set firewall ipv4 name eth3-outside-filter rule 3000 action 'drop'    # block new storage->mgmt
...
set firewall ipv4 name eth3-outside-filter rule 3010 action 'drop'    # block new class->mgmt
...
set firewall ipv4 name eth4-inside-filter rule 10 action 'accept'      # class->mgmt established
...
set firewall ipv4 name eth4-inside-filter rule 3000 action 'drop'      # block class->storage
...
set firewall ipv4 name eth4-inside-filter rule 3010 action 'drop'      # block new class->mgmt
...
set firewall ipv4 name eth4-outside-filter rule 10 action 'accept'     # mgmt->class allow new & established
...
set firewall ipv4 name eth4-outside-filter rule 3000 action 'drop'     # block storage->class
